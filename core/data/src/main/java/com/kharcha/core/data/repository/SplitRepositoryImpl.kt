...
import com.kharcha.core.model.SplitType
...
class SplitRepositoryImpl @Inject constructor(
    ...
    override suspend fun exportGroup(groupId: Long): String {
        ...
        // 4. Map to DTOs
        val groupDto = com.kharcha.core.data.dto.GroupDto(
        ...
        val memberDtos = memberEntities.map { 
            com.kharcha.core.data.dto.MemberDto(
                uuid = it.uuid,
                name = it.name,
                phone = it.phone
            ) 
        ...
        val expenseDtos = expenseEntities.map { expense ->
            ...
            val shareDtos = expenseShares.map { share ->
                ...
                com.kharcha.core.data.dto.ShareDto(memberUuid = memberUuid, shareAmount = share.shareAmount)
            }
            val payerUuid = memberEntities.find { it.id == expense.paidByMemberId }?.uuid ?: ""
            
            com.kharcha.core.data.dto.ExpenseDto(
                uuid = expense.uuid,
        ...
        val syncDto = com.kharcha.core.data.dto.GroupSyncDto(
            group = groupDto,
            members = memberDtos,
    ...
    override suspend fun importGroup(json: String): Boolean {
        try {
            val dto = com.google.gson.Gson().fromJson(json, com.kharcha.core.data.dto.GroupSyncDto::class.java)
