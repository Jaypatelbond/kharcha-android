...
object NotificationHelper {
    ...
    fun createNotificationChannel(context: Context) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val descriptionText = "Reminds you to log daily expenses"
    ...
    fun showReminderNotification(
        context: Context,
        title: String = "Did you spend today?",
        message: String = "Don't forget to log your daily expenses in Kharcha!"
    ) {
