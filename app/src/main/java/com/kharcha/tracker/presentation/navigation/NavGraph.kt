...
import com.kharcha.tracker.presentation.screens.addtransaction.AddTransactionScreen
import com.kharcha.tracker.presentation.screens.dashboard.DashboardScreen
import com.kharcha.tracker.presentation.screens.history.HistoryScreen
        ...
        composable(Routes.DASHBOARD) {
            DashboardScreen(
                onTransactionClick = { id ->
                    navController.navigate(Routes.editTransaction(id))
                },
                navController = navController
            )
        }
