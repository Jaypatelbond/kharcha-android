...
import com.kharcha.tracker.presentation.components.TransactionOptionsSheet
...
fun HistoryListContent(
    transactions: List<com.kharcha.tracker.domain.model.Transaction>,
    isLoading: Boolean,
    searchQuery: String,
    onTransactionClick: (Long) -> Unit,
    onDelete: (com.kharcha.tracker.domain.model.Transaction) -> Unit,
    onLongClick: (com.kharcha.tracker.domain.model.Transaction) -> Unit
) {
        if (isLoading) {
             Column(
