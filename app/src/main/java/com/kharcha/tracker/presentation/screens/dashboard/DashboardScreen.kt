...
import com.kharcha.tracker.presentation.components.AdMobBanner
import com.kharcha.tracker.presentation.components.EmptyState
import com.kharcha.tracker.presentation.components.TransactionCard
...
fun DashboardScreen(
    ...
    val isAdFree by mainViewModel.isAdFree.collectAsState()
    ...
    var showDeleteDialog by androidx.compose.runtime.remember { androidx.compose.runtime.mutableStateOf<com.kharcha.tracker.domain.model.Transaction?>(null) }
    var showOptionsFor by androidx.compose.runtime.remember { androidx.compose.runtime.mutableStateOf<com.kharcha.tracker.domain.model.Transaction?>(null) }
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            // Calendar Week View
            item {
                com.kharcha.tracker.presentation.components.CalendarWeekView(
                ...
                if (state.isLoading) {
                    Row(
                        ...
                        horizontalArrangement = Arrangement.spacedBy(16.dp)
                         ...
                         com.kharcha.tracker.presentation.components.ShimmerItem(
                             modifier = Modifier
                                 .weight(1f)
                                 .height(160.dp)
                         )
                         ...
                         Column(
                             ...
                             com.kharcha.tracker.presentation.components.ShimmerItem(modifier = Modifier.weight(1f).fillMaxWidth())
                             com.kharcha.tracker.presentation.components.ShimmerItem(modifier = Modifier.weight(1f).fillMaxWidth())
                         }
                    }
                } else {
                    AnimatedVisibility(
                        ...
                        com.kharcha.tracker.presentation.components.OverviewCards(
    ...
    if (showOptionsFor != null) {
        com.kharcha.tracker.presentation.components.TransactionOptionsSheet(
            transaction = showOptionsFor!!,
            onDismiss = { showOptionsFor = null },
            onEdit = { 
                onTransactionClick(showOptionsFor!!.id) 
            },
            onDelete = { 
        ...
        androidx.compose.material3.AlertDialog(
            ...
            confirmButton = {
                androidx.compose.material3.TextButton(
                    ...
                    colors = androidx.compose.material3.ButtonDefaults.textButtonColors(contentColor = com.kharcha.tracker.presentation.theme.ExpenseRed)
                ) {
                    Text("Delete")
                }
            },
