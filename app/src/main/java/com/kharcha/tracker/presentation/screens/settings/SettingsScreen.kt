...
fun SettingsScreen(
    ...
    val adManager = androidx.compose.runtime.remember { com.kharcha.tracker.util.AdManager(context) }
    // Preload ad
    LaunchedEffect(Unit) {
    ...
    if (showAdOfferDialog) {
        com.kharcha.tracker.presentation.components.AdFreeOfferDialog(
