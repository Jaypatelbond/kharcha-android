package com.kharcha.tracker.data.local
...
@Database(
    entities = [
        ...
        com.kharcha.tracker.data.local.entity.CategoryEntity::class,
        com.kharcha.tracker.data.local.entity.RecurringTransactionEntity::class,
        com.kharcha.tracker.data.local.entity.LoanEntity::class,
        CreditCardEntity::class,
        IncomeProfileEntity::class,
        com.kharcha.tracker.data.local.entity.BudgetEntity::class
    ],
    version = 9,
    exportSchema = false
)
abstract class AppDatabase : RoomDatabase() {
    ...
    abstract fun categoryDao(): com.kharcha.tracker.data.local.dao.CategoryDao
    abstract fun recurringDao(): com.kharcha.tracker.data.local.dao.RecurringDao
    abstract fun loanDao(): com.kharcha.tracker.data.local.dao.LoanDao
    abstract fun creditCardDao(): CreditCardDao
    abstract fun incomeDao(): IncomeDao
    abstract fun budgetDao(): com.kharcha.tracker.data.local.dao.BudgetDao
    ...
    companion object {
        ...
        val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(database: SupportSQLiteDatabase) {
                ...
                val defaults = com.kharcha.tracker.data.local.util.CategoryDefaults.getPrepopulatedCategories()
